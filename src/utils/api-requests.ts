...
export const deleteAPI = async <T extends object = object>(url: string, params?: APIRequestParams, config?: AxiosRequestConfig) => await requestAPI<T>(url, 'delete', params, {}, config);
...
export const getAPI = async <T extends object = object>(url: string, params?: APIRequestParams, config?: AxiosRequestConfig) => await requestAPI<T>(url, 'get', params, {}, config);
...
export const patchAPI = async <T extends object = object>(url: string, data?: APIRequestData, config?: AxiosRequestConfig<APIRequestData>) => await requestAPI<T>(url, 'patch', {}, data, config);
...
export const postAPI = async <T extends object = object>(url: string, data?: APIRequestData, config?: AxiosRequestConfig<APIRequestData>) => await requestAPI<T>(url, 'post', {}, data, config);
...
export const putAPI = async <T extends object = object>(url: string, data?: APIRequestData, config?: AxiosRequestConfig<APIRequestData>) => await requestAPI<T>(url, 'put', {}, data, config);
