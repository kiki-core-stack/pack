...
Object.defineProperty(globalThis, 'requireTwoFactorAuthentication', {
	configurable: false,
	async value(request: Request, emailOtp?: boolean, totp?: boolean, admin?: AdminDocument, autoSendEmailOtpCode?: boolean) {
		// @ts-expect-error
...
Object.defineProperty(globalThis, 'sendEmailOtpCode', {
	configurable: false,
	async value(admin: AdminDocument) {
