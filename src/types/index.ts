...
declare global {
	...
	type ZodValidatorType<Output = any, O extends Exclude<keyof Output, 'id' | keyof TwoFactorAuthenticationCodesData> = never, Def extends ZodTypeDef = ZodTypeDef> = ZodType<
